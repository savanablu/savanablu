...
export default function HomeHero() {
  ...
  return (
    <section
      className="relative w-full min-h-[80vh] sm:min-h-[80vh] overflow-hidden"
    ...
    >
      ...
      {/* Hero content */}
      <div className="relative flex min-h-[80vh] sm:min-h-[80vh] items-center px-6 sm:px-8 lg:px-12">
